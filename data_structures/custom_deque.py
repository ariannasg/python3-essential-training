...
class Deque:
    ...
    def add_front(self, item):
        ...
        into the front of a list, all the other items in the list need to
    ...
    def add_rear(self, item):
        """Takes in an item as a parameter and appends that item to the
        end of the list that is representing the Deque.

        The runtime is constant because appending to the end of a list
    ...
    def remove_front(self):
        ...
        from the 0th index, all the other items have to shift one
        index to the left.
        """
    ...
    def remove_rear(self):
        ...
        The runtime is constant because all we're doing is indexing to
        the end of a list.
        """
    ...
    def peek_front(self):
        ...
        The runtime is constant because all we're doing is indexing
        into a list.
        """
    ...
    def size(self):
        ...
        The runtime will be constant because all we're doing is
    ...
    def is_empty(self):
        ...
        The runtime is constant because all we're doing is comparing
        two values.
        """
